...
const Form = () => {
  return (
    <form>
      <Inputs labelFor="fullname" labelText="Fullname" typeInput="text">insert your name here...</Inputs>
      ...
      <Button bgColor="bg-slate-200" textColor="text-slate-900" otherClasses="w-full">Register</Button>
    </form>
  )
}
